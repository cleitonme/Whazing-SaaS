...
1. Conecte o canal normalmente (leitura do **QR Code**).
...
Para a API PLUS, a importação é feita **por contato**, de forma manual:
...
Uma boa prática é **importar as mensagens usando a Baileys** e, depois da importação, **desconectar o canal e conectar na API PLUS** — assim você mantém o histórico e aproveita os recursos extras da PLUS.
