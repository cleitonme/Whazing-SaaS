...
> 💡 **Nunca configurou um webhook?** Comece pela página [Webhooks](./) — a lógica é a mesma: o sistema envia uma requisição `POST` em formato `JSON` para a **URL** que você informar, toda vez que um evento marcado acontecer.
