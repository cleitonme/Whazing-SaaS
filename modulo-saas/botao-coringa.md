description: >-
O Botão Coringa permite adicionar um botão extra no menu principal do sistema,
funcionando como um atalho personalizado para sites, sistemas ou ferramentas externas.
--------------------------------------------------------------------------------------

# 🎛️ Botão Coringa

O **Botão Coringa** é um recurso que permite adicionar um botão adicional no menu principal do sistema.
Ele funciona como um **atalho rápido e personalizável**, ideal para acessar sistemas parceiros, painéis externos, documentações ou qualquer link desejado.
...
4. Preencha os campos:
   ...
   * 🏷️ **Nome do botão**
     Texto que será exibido no menu principal.
   * 🔗 **Link do botão**
     Endereço (URL) que será aberto ao clicar no botão.
   * 🎨 **Ícone (MDI)**
     Ícone que será exibido junto ao nome do botão no menu.
...
<figure><img src="../.gitbook/assets/image (8) (1) (1) (1).png" alt=""><figcaption>Exemplo do Botão Coringa exibido no menu principal</figcaption></figure>

---

## 🎨 Sugestão de Ícones (MDI)

O campo **Ícone** utiliza a biblioteca **Material Design Icons (MDI)**.
Sempre utilize o prefixo **`mdi-`** antes do nome do ícone.
...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption>Configuração de menu por empresa</figcaption></figure>

<figure><img src="../.gitbook/assets/image (2).png" alt=""><figcaption>Personalização do Botão Coringa por empresa</figcaption></figure>
