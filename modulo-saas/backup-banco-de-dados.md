...
2. Abra a empresa/painel de administração e localize o cartão **"Backup do Banco"** (categoria **Configurações** — use a busca do painel digitando "backup" se preferir).
...
**Sugestão de print:** tela **Backup do Banco** completa (Situação + Backup automático).

**Onde colocar:** logo após a lista "Onde encontrar".

**Objetivo:** mostrar de uma vez onde ficam o ativar/desativar, o horário, a frequência, o destino e o botão de backup manual — as cinco dúvidas mais comuns sobre o recurso.
