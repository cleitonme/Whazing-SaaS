...
* [Funcionalidades](funcionalidades/README.md)
  * [Atendimento](funcionalidades/atendimento/README.md)
    ...
    * [Follow-up](funcionalidades/atendimento/follow-up.md)
    * [Melhorar Texto de Atendimento](funcionalidades/atendimento/melhorar_texto_atendimento.md)
    * [Despedida](funcionalidades/atendimento/despedida.md)
    * [Motivos de Encerramento](funcionalidades/atendimento/motivos-de-encerramento-de-tickets.md)
  * [Automação](funcionalidades/automacao/README.md)
    * [CHATBOT INTERNO](funcionalidades/automacao/chatbotinterno.md)
    * [Fluxos por palavra chave](funcionalidades/automacao/fluxo-por-palavra-chave.md)
    * [Campanhas](funcionalidades/automacao/campanha.md)
* [Documentação](docs/README.md)
  ...
  * [⚙️ Configurações do WHAZING](docs/configuracoes.md)
