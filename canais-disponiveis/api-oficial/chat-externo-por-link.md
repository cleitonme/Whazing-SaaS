...
**📸 Sugestão de print:** página do cliente no chat externo (celular) e, ao lado, a conversa no Atendimento.
...
**"O botão de enviar o link não aparece."**
Ele só existe em conversas de **WABA/Hub WhatsApp** e com o atendimento **em aberto**. Se o chat externo **já está ativo** nessa conversa, o botão some — o que aparece é o banner com **"Voltar para WhatsApp"**.

**"O cliente abriu o link e pediu senha."**
A senha são os **4 últimos números do telefone dele** — o sistema pede para proteger o chat. Se não quiser esse passo, desative **"Pedir senha para acessar o chat"** nas configurações.

**"O cliente diz que o link não abre mais."**
O link pode ter expirado. Clique novamente em **"Enviar link do chat externo"** para gerar e reenviar.

**"Mudei de ideia e quero voltar ao WhatsApp."**
Clique em **"Voltar para WhatsApp"** no banner acima do campo de mensagem. A conversa segue normalmente pelo WhatsApp.

**"Não achei a opção de ativar o chat externo."**
Ela fica em **Configurações → Atendimento**, com o nome **"Modo alternativo (chat externo por link)"**. Somente administradores têm acesso às configurações.
