...
* Envia automaticamente anúncios e/ou menções à marca **Whazing** em situações como: abertura de tickets, envio de mensagens pela API, follow-ups e mensagens agendadas.
* Não inclui suporte, atualizações ou personalizações.

**3.2 Versão Premium 💎**

* Não possui as limitações da versão grátis.
* Não exibe anúncios nem insere propagandas automáticas.
...
O cliente reconhece e concorda que determinados recursos do sistema dependem de **serviços externos**, que **não estão incluídos na licença** e podem gerar custos adicionais. Entre eles:

* Hospedagem/VPS/servidor ou infraestrutura utilizada;
...
Todo o conteúdo, código-fonte, identidade visual, marca e demais elementos do software são de propriedade exclusiva da empresa desenvolvedora e protegidos por leis de direitos autorais e propriedade intelectual.
...
* Problemas relacionados à infraestrutura do cliente (servidor, rede, VPS, banco de dados, domínio etc.);
* Perdas causadas por uso incorreto, falhas externas, indisponibilidade de serviços de terceiros ou descumprimento de normas legais.
